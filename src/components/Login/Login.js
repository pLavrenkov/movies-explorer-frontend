    ...
    <section className='login'>
      ...
      <Form name={'login'} buttonName={'Войти'} buttonState={isButtonDisabled}>
        <p className='form__set'>
          ...
          <input id='login-email' type='email' className='form__input' required placeholder='Введите еmail'></input>
          <span className='form__error'></span>
        </p>
        <p className='form__set'>
          <label htmlFor='login-password' className='form__label'>Пароль</label>
          <input id='login-password' type='password' className='form__input' required placeholder='Введите пароль'></input>
